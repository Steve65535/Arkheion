...
module.exports = async function list({ rootDir, args = {} }) {
    try {
        ...
        console.log(`${logger.COLORS.brightPurple}└─────┴──────────────────────┴───────────┴──────────┴─────────────┘${logger.COLORS.reset}`);
        console.log('');
        console.log(`${logger.COLORS.brightYellow}Tip:${logger.COLORS.reset} Use ${logger.COLORS.brightBlue}fsca wallet info <txIndex>${logger.COLORS.reset} to view details`);
        console.log('');
